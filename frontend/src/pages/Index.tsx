...
<div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] flex items-center justify-center mt-20">
  <motion.div 
    ...
    className="relative"
  >
    {/* Main curved path - made larger */}
    <svg width="1000" height="600" viewBox="0 0 1000 600" className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
      <motion.path
  ...
  },
  {
    ...
    gradientClass: "bg-gradient-to-b from-[#F8E38F] via-[#F8E38F] via-62% to-white"
  }
].map((feature, index) => (
  <motion.div
    key={index}
  ...
  >
    <div className="text-4xl mb-4 mr-4flex justify-center">{feature.icon}</div>
    ...
    <p className="text-muted-foreground text-center">{feature.description}</p>
      ...
      <motion.div 
        ...
        className="bg-gradient-to-b from-[#F8E38F] via-[#FFFF] py-16"
      >
